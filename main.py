...
@app.get("/subscription/payment")
def subscription_payment(phone: str = ""):
    return RedirectResponse(url=f"/onboarding?phone={phone}", status_code=302)
...
<style>
  ...
  p{color:#666;font-size:.95rem;line-height:1.55;margin-bottom:20px}
  .wa-btn{display:inline-block;background:#25d366;color:#fff;text-decoration:none;font-weight:700;font-size:1.05rem;padding:14px 28px;border-radius:12px}
...
<div class="card">
  ...
  <h1>\u00a1Listo! Tus 7 d\u00edas gratis empezaron</h1>
  <p>Volv\u00e9 a WhatsApp y escrib\u00ed "hola" para empezar con tu coach.</p>
  <a class="wa-btn" href="https://wa.me/14155238886">Abrir WhatsApp \u2192</a>
</div>
</body>
</html>""")
